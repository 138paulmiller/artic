...
Ray3f Light::makeShadowRay(const Vec3f & poi, double & intensity){
}
...
Ray3f PointLight::makeShadowRay(const Vec3f & poi, double & intensity){
...
Ray3f RectangleLight::makeShadowRay(const Vec3f & poi, double & intensity){
	//offset pos
	Vec3f pos = _pos;
	//move 
